...
- [Good Jobs Digest](https://github.com/piotr-malek/my_python_projects/tree/main/good_jobs_digest)
  - Aggregates purpose-driven job boards and 200+ curated employer ATS feeds, scores each posting against your profile with a local LLM, and emails a ranked daily shortlist. Ships a mission-filtered company registry as CSV so it works without running discovery yourself.
  - Python, job-board scrapers, Greenhouse/Lever/SmartRecruiters, Ollama, BigQuery, SMTP
